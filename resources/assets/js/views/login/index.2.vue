      ...
      <Col class="loginFrom">
        ...
        <Form ref="form" :model="form" :rules="ruleInline">
          <FormItem prop="username">
            <Input type="text" size="large" v-model="form.username" :placeholder="$t('login.username')">
          ...
          <FormItem class="bottom">
            <Button type="primary" @click="submit('form')" id="loginButton" size="large" long :loading="loading">登录</Button>
          </FormItem>
        </Form>
      </Col>
    </Row>
