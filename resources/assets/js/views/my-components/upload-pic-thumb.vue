<template>
  <div>
    <div :key="index" class="upload-list" v-for="(item,index) in uploadList">
      <template v-if="item.status == 'finished'">
        ...
        <div class="upload-list-cover">
          <Icon @click="handleView(item.url)" type="ios-eye-outline"></Icon>
    ...
    <Upload
      ...
      type="drag"
    >
      <div style="width: 158px;height:100px;line-height: 100px;" v-show="showDrag">
        <Icon size="20" type="md-add"></Icon>
      </div>
    </Upload>

    <Modal :styles="{top: '30px'}" draggable title="图片预览" v-model="viewImage">
