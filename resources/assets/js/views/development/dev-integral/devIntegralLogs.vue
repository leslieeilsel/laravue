...
<script>
  import {
    devIntegralLogs,devIntegralLogsDel,dictData
  } from '../../../api/value';
  ...
  export default {
                  ...
                  on: {
                    click: () => {
                      this.$Modal.confirm({
                        ...
                        onOk: () => {
                          devIntegralLogsDel({id: params.row.id}).then(res => {
                            if (res.result === true) {
    ...
    methods: {
      init() {
        this.getDevIntegralLogs();
      },
      getDevIntegralLogs() {
        this.tableLoading = true;
        devIntegralLogs(this.searchForm).then(res => {
