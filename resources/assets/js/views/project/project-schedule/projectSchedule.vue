  ...
  <Card>
    ...
    <Modal
      ...
      <Form ref="form" :model="form" :label-width="150" :rules="formValidate">
        ...
        <Row>
          <Col span="11">
            <FormItem label="累积完成投资(万元)" prop="acc_complete">
  ...
  export default {
    data() {
      return {
                    ...
                    click: () => {
                      ...
                      this.data.forEach(function (em) {
                        if (em.id === params.row.id) {
                          ...
                          console.log('TCL: data -> img_pic', img_pic)
        ...
        start_month_act: '1- 月实际完成投资(万元)',
        month_img: 'x月形象进度',
        month_act: 'x月实际完成投资(万元)',
        year_investors: '2019年计划投资(万元)',
        year_img: '2019年形象进度',
        form: {
          month: '',
          project_id: '',
    ...
    methods: {
      ...
      changeMonth(e) {
        ...
        this.start_month_act = '开始到' + e + ' 月实际完成投资(万元)';
